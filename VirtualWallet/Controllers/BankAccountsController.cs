...
namespace VirtualWallet.Controllers
{
    public class BankAccountsController : Controller
    {
        ...
        public PartialViewResult _CreateAccountModal()
        {
        ...
        public ActionResult Create(BankAccount account, decimal startingBalance)
        {
            ...
            //TempData["AccountCreateMsg"] += "<p  class=\"text-danger\">Something went wrong. Account wasn't created!</p>";
            //return Redirect(Request.UrlReferrer.ToString());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,OwnerId,AccountName,Created,StartingBalance,CurrentBalance,WarningBalance,IsDeleted,AcountType")] BankAccount bankAccount)
        {
